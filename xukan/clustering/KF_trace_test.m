...
for round_KF=1:200
    ...
    if round_KF==50
        flood_alpha(1,1)=flood_alpha(1,1)-skew_jump;
    end
    ...
    elseif flood_neb_history_KF(1,1)~=0&&flood_neb_history_KF(1,5)==0
        ...
        %卡尔曼滤波过程
        [flood_xnew,flood_Pnew,nis]=test_clock_sync_kf(flood_x,...
            flood_P, ...
            t_send_i_j-flood_neb_history_KF(1,2), ...
            t_send_i_j, ...
            t_receive_j-flood_range);
        nis_trace(round_KF,1)=nis;
...
alpha_master=zeros(200,1);
for i=1:49
    alpha_master(i,1)=flood_alpha(1,1)+skew_jump;
end
for i=50:200
    alpha_master(i,1)=flood_alpha(1,1);
end
skew_flood_KF=l_KF*flood_alpha(2,1)-alpha_master;
...
skew_flood_LR=l_LR*flood_alpha(2,1)-alpha_master;
...
skew_flood_LP=l_LP*flood_alpha(2,1)-alpha_master;
