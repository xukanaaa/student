...
%                                         C(k3,12)=l(k3,1);
                                    ...
                                    elseif (C(k3+num_drones*2,1)<j-1)||(C(k3+num_drones*2,1)>=j-1&&C(k3+num_drones*2,14)>0&&C(k3+num_drones*2,14)<m1)
                                        %分别填充同步轮次，二跳邻居和自身时钟，估计所用数据轮数，l值
...
%                                         C(k3,12)=l(k3,1);
                    ...
                    elseif C(d(i)+num_drones*2,1)==0||C(d(i)+num_drones*2,14)==1||C(d(i)+num_drones*2,14)==2||C(d(i)+num_drones*2,14)==3
                        ...
                        for k1=1:5
                            C(d(i)+num_drones*2,2*k1)=t_local_total(d(i),j)+dt*(k1-1)+0*randn;
