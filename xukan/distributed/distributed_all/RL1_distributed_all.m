...
% hold on;
%semilogy(1:simulation_k,clockFinal(1:end),'-bs','LineWidth',1);
%semilogy(1:simulation_k,clock_varFinal(1:end),'-*','LineWidth',1);
%plot(1:simulation_k,complexity_result(1:end),'-*','LineWidth',1);
plot(5:5:simulation_k,complexity_result(5:5:end),'-bs','LineWidth',1);
xlabel('同步轮数');  % 添加x轴标签
