...
for r=1:5
    ...
    for j=1:simulation_k
        for i=1:num_drones
            ...
            %第一轮不更新，从第二轮开始
            if j>=2
                M=MulBroVirLink_alphaThreeRouTnoise_l(Neb_list_new{d(i)},j,num_drones,l(d(i),1));%更新逻辑时钟频偏参数
    ...
    for j=1:simulation_k
        for i=1:num_drones
            ...
            %第一轮不更新，从第二轮开始
            if j>=2
                l(d(i),1)=MulBro_TwoRouTnoise_l(Neb_list_old{d(i)},j,num_drones,l(d(i),1));%更新逻辑时钟频偏参数
