    ...
    for i=1:num_drones
        ...
        for k=1:num_drones
            if A(d(i),k)==1
                ...
                C(d(i),6)=C(d(i),2);
                C(d(i),7)=C(d(i),3);
                C(d(i),2)=t_local_total(d(i),j)+1e-7*randn;
                C(d(i),3)=(((t_local_total(d(i),j)-beta(d(i),1))/(alpha(d(i),1)))+B(d(i),k)/3e8)*alpha(k,1)+beta(k,1)+1e-7*randn;
                ...
                if j>2
                    if ((l_total(d(i),j-1)-l_total(d(i),j-2))<=thre)
                        C(d(i),1)=j;
                    end
                    if ((l_total(d(i),j-1)-l_total(d(i),j-2))>thre)
                        C(d(i),1)=-j;
